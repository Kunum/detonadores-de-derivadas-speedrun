        ...
        return (
            <div id="menu">
                <div id="menu-items">
                    ...
                    <p><a href="https://speedrun.derivadas.kunum.com/leaderboard">Placar</a></p>

                    <p onClick={()=>{
                        setDisplay(false);
                        props.onReset();
                    }}>Resetar progresso</p>
                    <p><a href="https://github.com/Kunum/detonadores-de-derivadas-speedrun" rel="noreferrer" target="_blank">Ver código fonte</a></p>
                </div>
